...
// function tinhTrungBinh(x, y){
  
//   return ((x + y) % 2 ).toFixed(2);

// }

// var sum = tinhTrungBinh(5, 10);
...
const random = () => {let x = Math.floor(Math.random() * 11);  return x;}


const tinhTrungBinh = (x, y) =>  ((x + y) % 2 ).toFixed(2);


const person = (person1, person2) => ({ name: "anonymous",age: 23, averageRank: 5.0,})
